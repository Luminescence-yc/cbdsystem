...
public interface ICompanyDao {
     ...
     * @return 0存在，非0不存在
     */
    int findCompanyByUsername(String username);
     ...
     * @return 企业用户分页对象集合
     */
    List<CompanyEntity> findCompanyByCondition(Page<CompanyEntity> page, Map<String, String> condition);
